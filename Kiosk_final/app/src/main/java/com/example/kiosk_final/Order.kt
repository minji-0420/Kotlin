...
class OrderManager {
    private val previousOrderList: MutableList<MenuItem> = mutableListOf()
    private val currentOrderList: MutableList<MenuItem> = mutableListOf()
    ...
    private fun sum(orderList: List<MenuItem>): Int {
        var sumPrice = 0
